...
export default function EventsList() {
  ...
  // Add event listener for search term from navbar
  useEffect(() => {
    ...
    return () => window.removeEventListener('searchEvents', handleSearch as EventListener);
  }, []);
  ...
  return (
    <>
      <PageBackground pageType="events" />
